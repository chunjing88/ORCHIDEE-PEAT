...
!$omp threadprivate(sla_min)
  ...
  !
!!!qcj++ peatland
  LOGICAL,ALLOCATABLE, SAVE, DIMENSION(:) :: is_peat
!$OMP THREADPRIVATE(is_peat)
  LOGICAL,ALLOCATABLE, SAVE, DIMENSION(:) :: is_croppeat
!$OMP THREADPRIVATE(is_croppeat)
  LOGICAL,ALLOCATABLE, SAVE, DIMENSION(:) :: is_shrubpeat
!$OMP THREADPRIVATE(is_shrubpeat)
  LOGICAL,ALLOCATABLE, SAVE, DIMENSION(:) :: is_mosspeat
!$OMP THREADPRIVATE(is_mosspeat)
  LOGICAL,ALLOCATABLE, SAVE, DIMENSION(:) :: is_mineralwet
!$OMP THREADPRIVATE(is_mineralwet)
...
!qcj++ peatland
  REAL(r_std), ALLOCATABLE, SAVE, DIMENSION(:) :: wtpwet_crit  !critical minimum wtp, m
!$OMP THREADPRIVATE(wtpwet_crit)
  REAL(r_std), ALLOCATABLE, SAVE, DIMENSION(:) :: wtpdry_crit  !critical maximum wtp, m
!$OMP THREADPRIVATE(wtpdry_crit)
  REAL(r_std), ALLOCATABLE, SAVE, DIMENSION(:) :: wtp_crit  !critical maximum wtp, m
!$OMP THREADPRIVATE(wtp_crit)
  REAL(r_std), ALLOCATABLE, SAVE, DIMENSION(:) :: wt_mortality
!$OMP THREADPRIVATE(wt_mortality)
